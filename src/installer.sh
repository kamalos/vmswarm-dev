...
# Compatible with Ubiquity (Linux Mint) and Debian Installer
...
# Ubiquity-specific settings for Linux Mint Live installation
# These enable automatic installation in the Live environment
...
inject_preseed_into_iso() {
  ...
  # Modify boot configuration to use preseed for automatic installation
...
GRUBCFG
  ...
  # Rebuild ISO with preseed and modified boot config
  log_info "Rebuilding ISO with preseed file and boot configuration..."
